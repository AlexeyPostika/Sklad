...
namespace Sklad_v1_001.FormUsers.RegisterDocumetnDelivery
{
    ...
    public class RegisterDocumentDeliveryLogic
    {
        ...
        public RegisterDocumentDeliveryLogic(Attributes _attributes)
        {
