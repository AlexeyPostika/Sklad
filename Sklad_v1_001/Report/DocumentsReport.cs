...
using POS.Helper;
using POS.Report.SchetFactura1Document;
using POS.Report.SchetFactura2Document;
using POS.Report.Torg12Document;
using POS.Report.Torg13Document;
using POS.Screens.Location;
using POS.Screens.Stones;
using System;
...
namespace POS.DocumentsReport
{
    ...
    public class DocumentsReport
    {
        ...
        {
            _locnumeric = _numeric;
            _locdataBase = _databasedata;

            documentStoneLogic = new StoneLogic(_numeric, _databasedata);
